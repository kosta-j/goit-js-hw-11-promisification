...
Напиcать функцию `delay(ms)`, которая возвращает промис, переходящий в состояние
...
Переписать функцию `toggleUserState()` так, чтобы она не использовала
...
Переписать функцию `makeTransaction()` так, чтобы она не использовала
